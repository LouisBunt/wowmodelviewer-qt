...
Released publicly at **1.0.0** and now at **1.1.0** — the early-access line before it
(1.5.0–1.8.0) never left this machine and lives on only in the history. The features
below are tested and do what this says, but several areas of the old interface are not
ported yet. See
